...
<head>
    ...
    <script src="/olm12/OAuthServer/js/jsencrypt.min.js"></script>
    <style>
        body {
            line-height: 1.15;
...
<body>
    <div class="login-area" role="main">
        ...
        <!-- Updated form action -->
        <form class="login-area__form" id="LoginForm" action="/login" method="post">
            <input type="hidden" id="ReturnUrl" name="ReturnUrl" value="/olm12/OAuthServer/connect/authorize/callback?client_id=InnovatorClient&amp;redirect_uri=https%3A%2F%2Fexternal.steepgraph.com%2Folm12%2FClient%2FOAuth%2FRedirectCallback&amp;response_type=code&amp;scope=openid%20Innovator%20offline_access&amp;state=6b195745c3df4870a91199154fc8658d&amp;code_challenge=XSLoEcg2Koxpb2M3ASuUp5ez-DMBkGng_9tFjR7B9VQ&amp;code_challenge_method=S256&amp;response_mode=query">
            ...
            <div class="form-row">
                ...
                <div class="password-container">
                    <input type="password" autocomplete="off" required placeholder="Password" id="Password" name="password">
                    <span class="eye-icon" id="togglePassword">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" width="24" height="24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 12s3-8 11-8 11 8 11 8-3 8-11 8-11-8-11-8z"/>
    ...
    <script src="/olm12/OAuthServer/js/polyfills/cssrelpreload.min.js"></script>
    <script src="/olm12/OAuthServer/js/login.js"></script>
    <script src="/olm12/OAuthServer/js/app.js"></script>
</body>
</html>
